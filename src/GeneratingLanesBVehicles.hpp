#ifndef GENERATING_LANES_B_VEHICLES_HPP
#define GENERATING_LANES_B_VEHICLES_HPP
...
{
    public:
    LaneB(int x1,int y1,int x2,int y2,int speed,int size);
    void draw();
    void update();
    ...
    int Time;// Reads the time for the traffic light from theh file
